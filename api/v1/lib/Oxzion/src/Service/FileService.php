...
class FileService extends AbstractService
{
     ...
     * @return array Returns a JSON Response with Status Code and Created File.
     */
    public function getFile($id, $latest = false, $accountId = null, $getAll = false)
    {
        try {
            ...
            //
            $select = "SELECT oxf.id, oxf.uuid, oxf.data, ou.uuid as ownerId, ou.name as created_by, oae.uuid as entity_id,oae.id as entityId, oxf.fileTitle as title from ox_file oxf inner join ox_user as ou on `oxf`.created_by = `ou`.id
